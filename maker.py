...
class ImageGenerator:
    ...
    def __init__(self, input_img, output_img, first_text, second_text, country="ecu"):
    ...
    def processing(self):
        ...
        # Открываем флаг
        national_flag = Image.open("./flags/" + self.country.lower() + ".png")
        # Открываем лого
        ...
        background.save(self.output_img)
