...
class ImageGenerator:
    TTF_SOURCE = "./content/times.ttf"
    LOGO_SOURCE = "./content/logo.jpg"

    def __init__(self, input_img, first_text, second_text, country="ecu"):
    ...
    def processing(self):
        ...
        # Открываем флаг
        national_flag = Image.open("./content/flags/" + self.country.lower() + ".png")
        # Открываем лого
